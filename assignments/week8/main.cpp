...
void editPlaylist(int choice, std::string& playlistName, MusicLibrary& musicLibrary, PlaylistManager& playlistManager);
...
void addSongToPlaylist(int choice, Playlist* playlist, MusicLibrary& musicLibrary);
...
int main() {
    ...
    while (true) {
        ...
        switch(choice) {
            case 1: 
                std::cout << musicLibrary.showAllSongs() << std::endl;
                break;
            case 2: 
    ...
    try {
        ...
        while (true) {
            ...
            switch(choice) {
                ...
                case 5:
                    musicPlayer.stop();
                    std::cout << "Stopped current song ! ! !" << std::endl;
                    return;
            }
        }
    } catch (const MusicPlayerException& m) {
...
void addSongToPlaylist(int choice, Playlist* playlist, MusicLibrary& musicLibrary) {
    ...
    while (true) {
        ...
        int songIndex = inputChoice(1, musicLibrary.getSongCount()) - 1;
