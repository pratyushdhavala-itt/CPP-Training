...
Transaction::Transaction(double transactionAmount, TransactionType transactionType, double postTransactionBalance) 
    : Transaction(0, transactionAmount, transactionType, postTransactionBalance) {}

Transaction::Transaction(long destinationAccountNo, double transactionAmount, TransactionType transactionType, double postTransactionBalance) :
